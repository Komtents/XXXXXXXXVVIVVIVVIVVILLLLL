...
package world.komq.xvl.plugin.objects

import world.komq.xvl.plugin.XVLPluginMain
import world.komq.xvl.plugin.tasks.XVLConfigReloadTask
import world.komq.xvl.plugin.tasks.XVLGameTask
import world.komq.xvl.plugin.tasks.XVLOpeningTask
import world.komq.xvl.plugin.tasks.XVLSecondCountTask
...
object XVLGameContentManager {
    ...
    fun motd(): Component {
        ...
        return text("$mainMotdString").append(text("\n${getByChar(nextInt(0xFFFF00).toString())}by ContentManager."))
    }
